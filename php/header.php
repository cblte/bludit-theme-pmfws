...
<!-- overall big site header image - make it as wide as your body width is set to -->
  <img src="<?php echo HTML_PATH_THEME_IMG ?>/header_sunset.jpg" alt="<?php echo $site->title() ?> header image showing grass, water and a wooden boardwalk"> <!-- change this here for the header image -->
  ...
  <?php if ($site->mastodon()): ?>
    <a href="<?php echo $site->mastodon() ?>" target="_blank">mastodon</a>
  <?php endif ?>
  <?php if ($site->dribbble()): ?>
    <a href="<?php echo $site->dribbble() ?>" target="_blank">dribbble</a>
  <?php endif ?>
  <?php if ($site->VK()): ?>
    <a href="<?php echo $site->VK() ?>" target="_blank">VK</a>
  <?php endif ?>
  </nav>
